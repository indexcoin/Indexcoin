...
map<uint256, CBlockIndex*> mapBlockIndex;
 uint256 hashGenesisBlock("0x000005ece9566997224ef564f331b8411a74c599ee56ed6618f7c61411c80a95");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Index: starting difficulty is 1 / 2^12
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000005ece9566997224ef564f331b8411a74c599ee56ed6618f7c61411c80a95");
    }
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("IndexMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("IndexCoinMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running IndexMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
