...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Index  version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  indexd [options]                     " + "\n" +
                  "  indexd [options] <command> [params]  " + _("Send command to -server or indexd") + "\n" +
                  "  indexd [options] help                " + _("List commands") + "\n" +
                  "  indexd [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: Index.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: indexd.pid)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Index Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Index is probably already running."), strDataDir.c_str()));
    ...
    if (nLoadWalletRet != DB_LOAD_OK)
    {
        ...
        else if (nLoadWalletRet == DB_NONCRITICAL_ERROR)
        {
            ...
            strErrors << _("Error loading wallet.dat: Wallet requires newer version of Index") << "\n";
        else if (nLoadWalletRet == DB_NEED_REWRITE)
        {
            strErrors << _("Wallet needed to be rewritten: restart Index to complete") << "\n";
